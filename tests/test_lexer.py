...
class TestLexer(TestCase):
    ...
    def test_semantic_equals_comparitor(self):
        ...
        self.assertEqual(result.get_type(), LexerType.CALCULATION_LOGIC)
    ...
    def test_semantic_opening_round_bracket(self):
        ...
        self.assertIsNotNone(result)
        self.assertIsInstance(result, LexerResult)
        self.assertEqual(result.get_type(), LexerType.GRAMMAR_STRUCTURE)
        self.assertEqual(result.get_value(), "(")
    ...
    def test_semantic_colon(self):
        ...
        self.assertIsNotNone(result)
        self.assertIsInstance(result, LexerResult)
        self.assertEqual(result.get_type(), LexerType.META_LANGUAGE)
        self.assertEqual(result.get_value(), ":")
    ...
    #     self.assertEqual(state.get_line(), 1, "line should be 1")
    #     self.assertEqual(state.get_column(), 1, "column should be 1")
