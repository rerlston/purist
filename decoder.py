"""
Purist source code decoder, reads source code and discovers words, numbers, operators, etc
"""
...
class Decoder():
    """
    Purist Decoder, reads source code and discovers words, numbers, operators, etc
    """
    ...
    def next(self) -> Tuple[str|None, Error|None]:
        """
